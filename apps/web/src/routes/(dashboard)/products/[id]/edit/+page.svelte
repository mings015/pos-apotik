    ...
    <form method="POST"
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input id="edit-stock" name="stock" type="number" min="0" value={p.stock}
            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
        </div>
        <div>
          <label for="edit-minimumStock" class="block text-sm font-medium text-gray-700 mb-1">Stok Minimum</label>
          <input id="edit-minimumStock" name="minimumStock" type="number" min="0" value={p.minimumStock}
            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
        </div>
        <div class="col-span-2">
