<script lang="ts">
  ...
  const icons: Record<string, string> = {
    ...
    ruler:
      "M3 7a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V7zM3 13a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1v-4zM14 13a1 1 0 011-1h2a1 1 0 011 1v1h1a1 1 0 010 2h-1v1a1 1 0 01-1 1h-2a1 1 0 01-1-1v-4z",
    settings:
...
<aside
  class="flex flex-col bg-white border-r border-gray-200 transition-all duration-200 {collapsed
    ? 'w-16'
    : 'w-60'}"
>
  <div
    class="flex items-center gap-3 px-4 h-16 border-b border-gray-200 shrink-0"
  >
    <div
