...
<div class="fixed top-4 right-4 z-50 flex flex-col gap-2 w-80">
  {#each $toasts as toast (toast.id)}
    <div class="flex items-start gap-3 px-4 py-3 rounded-xl border shadow-md text-sm {styles[toast.type]} animate-in">
      <svg class="w-5 h-5 shrink-0 mt-0.5 {iconStyles[toast.type]}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
