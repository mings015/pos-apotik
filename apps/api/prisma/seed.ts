  ...
  if (existingPoCount === 0) {
    ...
    const rtn1 = await prisma.purchaseReturn.create({
      data: {
        ...
        createdAt: rtnDate,
        items: {
          create: [{ productId: productMap['OBB-001'].id, batchId: parBatchId, quantity: 5 }],
        },
      },
    })
    ...
    for (const gi of grItems3) {
      ...
      await prisma.stockMovement.create({
        data: {
          ...
          createdById: warehouseId, createdAt: po3Rcv,
        },
      })
    ...
    await prisma.purchaseOrder.create({
      data: {
        ...
        items: {
          create: [
            { productId: productMap['OBK-001'].id, quantity: 100, purchasePrice: 12000, subtotal: 1200000 },
          ],
        },
      },
    })
    ...
    await prisma.purchaseOrder.create({
      data: {
        ...
        items: {
          create: [
            { productId: productMap['OBK-003'].id, quantity: 50, purchasePrice: 8000, subtotal: 400000 },
          ],
        },
      },
    })
