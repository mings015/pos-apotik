...
async function main() {
  ...
  const categoryData = [
    ...
    },
    {
      ...
      description: "Obat bebas dengan batasan tertentu",
    },
    {
      name: "Suplemen & Vitamin",
      description: "Suplemen kesehatan dan multivitamin",
    },
    {
      name: "Alat Kesehatan",
    ...
    },
    {
      ...
      description: "Obat herbal dan jamu tradisional",
    },
    { name: "Produk Bayi", description: "Produk perawatan dan kesehatan bayi" },
    {
      name: "Kosmetik Medis",
      description: "Produk perawatan kulit dan kecantikan medis",
    },
  ];
  ...
  const productData = [
    {
      ...
      minimumStock: 20,
      description:
        "Analgesik dan antipiretik untuk meredakan demam dan nyeri ringan",
    },
    {
      code: "OBB-002",
      name: "Antasida Doen",
  ...
  if (existingBatchCount === 0) {
    ...
    const batchConfig = [
      ...
      {
        code: "OBB-001",
        batchNumber: "B-PAR-2025A",
        expired: daysFromNow(-5),
        qty: 20,
        actor: warehouseId,
        note: "Penerimaan batch lama",
      },
      {
        code: "OBB-001",
        batchNumber: "B-PAR-2026B",
        expired: daysFromNow(300),
        qty: 130,
        actor: warehouseId,
        note: "Penerimaan stok reguler",
      },

      // Antasida — 1 batch aman
      {
        code: "OBB-002",
        batchNumber: "B-ANT-2026A",
        expired: daysFromNow(280),
        qty: 80,
        actor: warehouseId,
        note: "Penerimaan stok reguler",
      },
      ...
      {
        code: "OBB-004",
        batchNumber: "B-IBU-2026A",
        expired: daysFromNow(450),
        qty: 100,
        actor: warehouseId,
        note: "Penerimaan stok reguler",
      },
      ...
      {
        code: "OBK-001",
        batchNumber: "B-AMX-2025A",
        expired: daysFromNow(-45),
        qty: 20,
        actor: warehouseId,
        note: "Batch lama — expired",
      },
      {
        code: "OBK-001",
        batchNumber: "B-AMX-2026B",
        expired: daysFromNow(450),
        qty: 180,
        actor: warehouseId,
        note: "Penerimaan stok baru",
      },

      // Ciprofloxacin — 2 batch: 1 near-expired, 1 aman
      {
        code: "OBK-002",
        batchNumber: "B-CIP-2025A",
        expired: daysFromNow(14),
        qty: 20,
        actor: warehouseId,
        note: "Batch mendekati expired",
      },
      {
        code: "OBK-002",
        batchNumber: "B-CIP-2026B",
        expired: daysFromNow(500),
        qty: 100,
        actor: warehouseId,
        note: "Penerimaan stok baru",
      },
      ...
      {
        code: "SUP-001",
        batchNumber: "B-VTC-2026A",
        expired: daysFromNow(600),
        qty: 250,
        actor: superAdminId,
        note: "Penerimaan stok reguler",
      },
      ...
      {
        code: "SUP-002",
        batchNumber: "B-VTD-2025A",
        expired: daysFromNow(-90),
        qty: 5,
        actor: warehouseId,
        note: "Batch lama — expired",
      },
      ...
      {
        code: "ALK-001",
        batchNumber: "B-BTD-2025A",
        expired: daysFromNow(25),
        qty: 30,
        actor: warehouseId,
        note: "Batch mendekati expired",
      },
      {
        code: "ALK-001",
        batchNumber: "B-BTD-2026B",
        expired: daysFromNow(350),
        qty: 40,
        actor: warehouseId,
        note: "Penerimaan stok baru",
      },
      ...
      {
        code: "ALK-002",
        batchNumber: "B-TNS-2026A",
        expired: daysFromNow(1200),
        qty: 10,
        actor: superAdminId,
        note: "Penerimaan alat kesehatan",
      },

      // Masker — 1 batch aman
      {
        code: "ALK-003",
        batchNumber: "B-MSK-2026A",
        expired: daysFromNow(280),
        qty: 50,
        actor: warehouseId,
        note: "Penerimaan stok reguler",
      ...
      {
        code: "HRB-001",
        batchNumber: "B-TLK-2025A",
        expired: daysFromNow(20),
        qty: 15,
        actor: warehouseId,
        note: "Batch mendekati expired",
      },
      ...
      {
        code: "HRB-002",
        batchNumber: "B-ATG-2026A",
        expired: daysFromNow(420),
        qty: 60,
        actor: warehouseId,
        note: "Penerimaan stok reguler",
      },
  ...
  if (existingPoCount === 0) {
    function makePoNumber(date: Date, seq: number) {
      const d = date.toISOString().slice(0, 10).replace(/-/g, "");
      return `PO-${d}-${String(seq).padStart(4, "0")}`;
    }
    function makeInvoiceNumber(date: Date, seq: number) {
      const d = date.toISOString().slice(0, 10).replace(/-/g, "");
      return `SINV-${d}-${String(seq).padStart(4, "0")}`;
    }
    function makeReturnNumber(date: Date) {
      const d = date.toISOString().slice(0, 10).replace(/-/g, "");
      return `RTN-${d}-0001`;
    }

    const date30 = daysFromNow(-30);
    const date28 = daysFromNow(-28);
    const date15 = daysFromNow(-15);
    const date10 = daysFromNow(-10);
    const date5 = daysFromNow(-5);
    const date2 = daysFromNow(-2);
    const date7 = daysFromNow(-7);

    // ── PO 1: RECEIVED — PT Kimia Farma ──────────────────────────────────────
    // Paracetamol 100 strip + Antasida 50 strip
    const po1Subtotal = 100 * 3500 + 50 * 4000; // 350000 + 200000 = 550000
    const po1 = await prisma.purchaseOrder.create({
      data: {
        poNumber: makePoNumber(date30, 1),
        supplierId: supMap["PT Kimia Farma"].id,
        subtotal: po1Subtotal,
        tax: 0,
        discount: 0,
        total: po1Subtotal,
        status: "RECEIVED",
        notes: "Pemesanan rutin bulanan stok Paracetamol dan Antasida",
        createdById: superAdminId,
        createdAt: date30,
        updatedAt: date28,
        items: {
          create: [
            {
              productId: productMap["OBB-001"].id,
              quantity: 100,
              purchasePrice: 3500,
              subtotal: 350000,
            },
            {
              productId: productMap["OBB-002"].id,
              quantity: 50,
              purchasePrice: 4000,
              subtotal: 200000,
            },
    ...
    // Goods Receiving untuk PO 1
    const gr1 = await prisma.goodsReceiving.create({
      data: {
        purchaseOrderId: po1.id,
        receivedById: warehouseId,
        notes: "Barang diterima lengkap sesuai PO",
        createdAt: date28,
      },
    });

    // Batch & stok untuk setiap item yang diterima
    const grItems1 = [
      {
        code: "OBB-001",
        qty: 100,
        batchNo: "B-PAR-PO1-01",
        expired: daysFromNow(365),
        price: 3500,
      },
      {
        code: "OBB-002",
        qty: 50,
        batchNo: "B-ANT-PO1-01",
        expired: daysFromNow(400),
        price: 4000,
      },
    ];
    const grBatchMap: Record<string, string> = {}; // code → batchId
    ...
    for (const gi of grItems1) {
      ...
      const batch = await prisma.productBatch.create({
        data: {
          productId: prod.id,
          batchNumber: gi.batchNo,
          expiredDate: gi.expired,
          quantity: gi.qty,
          createdAt: date28,
        },
      });
      ...
      await prisma.stockMovement.create({
        data: {
          ...
          quantity: gi.qty,
          beforeStock,
          afterStock: beforeStock + gi.qty,
          referenceType: "GOODS_RECEIVING",
          referenceId: gr1.id,
          notes: `Penerimaan barang PO ${po1.poNumber}`,
      ...
      await prisma.goodsReceivingItem.create({
        data: {
          goodsReceivingId: gr1.id,
          productId: prod.id,
          batchId: batch.id,
          quantity: gi.qty,
          purchasePrice: gi.price,
        },
      });
    }

    // Supplier Invoice untuk PO 1 (PARTIAL — sudah dibayar sebagian)
    const inv1 = await prisma.supplierInvoice.create({
      data: {
        purchaseOrderId: po1.id,
        invoiceNumber: makeInvoiceNumber(date28, 1),
        totalAmount: po1Subtotal,
        paidAmount: 300000,
    ...
    // Pembayaran pertama untuk invoice 1
    ...
    await prisma.stockMovement.create({
      data: {
        ...
        movementType: "RETURN",
        quantity: 5,
        beforeStock: parBefore,
        afterStock: parBefore - 5,
        referenceType: "PURCHASE_RETURN",
        referenceId: rtn1.id,
        notes: `Retur pembelian ${rtn1.returnNumber}`,
        createdById: warehouseId,
        createdAt: rtnDate,
      },
    });
    ...
    const po2Subtotal = 30 * 18000 + 100 * 6000; // 540000 + 600000 = 1140000
    await prisma.purchaseOrder.create({
      data: {
        poNumber: makePoNumber(date10, 1),
        supplierId: supMap["PT Kalbe Farma"].id,
        subtotal: po2Subtotal,
        tax: 0,
        discount: 50000,
        total: po2Subtotal - 50000,
        status: "APPROVED",
        notes: "Diskon khusus awal bulan dari Kalbe Farma",
        createdById: superAdminId,
        createdAt: date10,
        updatedAt: date10,
        items: {
          create: [
            {
              productId: productMap["OBB-003"].id,
              quantity: 30,
              purchasePrice: 18000,
              subtotal: 540000,
            },
            {
              productId: productMap["SUP-001"].id,
              quantity: 100,
              purchasePrice: 6000,
              subtotal: 600000,
            },
    ...
    const po3Subtotal = 80 * 5500 + 60 * 15000; // 440000 + 900000 = 1340000
    const po3Date = daysFromNow(-20);
    const po3Rcv = daysFromNow(-18);
    const po3 = await prisma.purchaseOrder.create({
      data: {
        poNumber: makePoNumber(po3Date, 1),
        supplierId: supMap["PT Dexa Medica"].id,
        ...
        items: {
          create: [
            {
              productId: productMap["OBB-004"].id,
              quantity: 80,
              purchasePrice: 5500,
              subtotal: 440000,
            },
            {
              productId: productMap["OBK-002"].id,
              quantity: 60,
              purchasePrice: 15000,
              subtotal: 900000,
            },
    ...
    const grItems3 = [
      ...
      },
      {
        code: "OBK-002",
        qty: 60,
        batchNo: "B-CIP-PO3-01",
        expired: daysFromNow(550),
        price: 15000,
      },
    ];
    for (const gi of grItems3) {
      const prod = productMap[gi.code];
      const prodData = await prisma.product.findUnique({
        where: { id: prod.id },
      });
      ...
      await prisma.stockMovement.create({
        data: {
          ...
          quantity: gi.qty,
          beforeStock: before,
          afterStock: before + gi.qty,
          referenceType: "GOODS_RECEIVING",
          referenceId: gr3.id,
          notes: `Penerimaan barang PO ${po3.poNumber}`,
          createdById: warehouseId,
          createdAt: po3Rcv,
        },
      });
    ...
    const inv3 = await prisma.supplierInvoice.create({
      data: {
        purchaseOrderId: po3.id,
        invoiceNumber: makeInvoiceNumber(po3Rcv, 2),
        totalAmount: po3Subtotal,
        paidAmount: po3Subtotal,
        paymentStatus: "PAID",
        createdAt: po3Rcv,
    ...
    // ── PO 4: PENDING — PT Sanbe Farma ───────────────────────────────────────
    await prisma.purchaseOrder.create({
      data: {
        poNumber: makePoNumber(date5, 1),
        supplierId: supMap["PT Sanbe Farma"].id,
        subtotal: 100 * 12000,
        tax: 0,
        discount: 0,
        total: 100 * 12000,
        status: "PENDING",
        notes: "Menunggu persetujuan kepala apotik",
        createdById: superAdminId,
        createdAt: date5,
        updatedAt: date5,
        items: {
          create: [
            {
              productId: productMap["OBK-001"].id,
              quantity: 100,
              purchasePrice: 12000,
              subtotal: 1200000,
            },
    ...
    // ── PO 5: DRAFT — PT Fahrenheit ──────────────────────────────────────────
    await prisma.purchaseOrder.create({
      data: {
        poNumber: makePoNumber(date2, 1),
        supplierId: supMap["PT Fahrenheit"].id,
        subtotal: 20 * 45000 + 10 * 85000,
        tax: 0,
        discount: 0,
        total: 20 * 45000 + 10 * 85000,
        status: "DRAFT",
        notes: "Draft pemesanan suplemen untuk bulan depan",
        createdById: superAdminId,
        createdAt: date2,
        updatedAt: date2,
        items: {
          create: [
            {
              productId: productMap["SUP-002"].id,
              quantity: 20,
              purchasePrice: 45000,
              subtotal: 900000,
            },
            {
              productId: productMap["SUP-003"].id,
              quantity: 10,
              purchasePrice: 85000,
              subtotal: 850000,
            },
    ...
    // ── PO 6: CANCELLED — PT Kimia Farma ─────────────────────────────────────
    await prisma.purchaseOrder.create({
      data: {
        poNumber: makePoNumber(date15, 2),
        supplierId: supMap["PT Kimia Farma"].id,
        subtotal: 50 * 12000,
        tax: 0,
        discount: 0,
        total: 50 * 12000,
        status: "CANCELLED",
        notes: "Dibatalkan — stok masih mencukupi",
        createdById: superAdminId,
        createdAt: date15,
        updatedAt: date15,
        items: {
          create: [
            {
              productId: productMap["OBK-003"].id,
              quantity: 50,
              purchasePrice: 8000,
              subtotal: 400000,
            },
    ...
    console.log(
      "Seed: 6 purchase order + 2 goods receiving + 2 supplier invoice + 2 payment + 1 purchase return dibuat",
    );
  } else {
